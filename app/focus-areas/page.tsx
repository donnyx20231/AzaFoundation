          ...
          <div className="space-y-12 sm:space-y-14 md:space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6">
                  <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-secondary/30">01</span>
                  <div>
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6">
                  <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-primary/30">02</span>
                  <div>
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6">
                  <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-secondary/30">03</span>
                  <div>
                    <div className="uppercase text-secondary font-semibold tracking-widest text-xs sm:text-sm">Focus Area</div>
              ...
              <div className="relative h-64 sm:h-80 md:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl">
                <Image src="/images/seth.jpg" alt="Community Development" fill className="object-cover" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              <div className="order-2 md:order-1 relative h-64 sm:h-80 md:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl">
                <Image src="/images/yannis.jpg" alt="Advocacy" fill className="object-cover" />
              </div>
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6">
                  <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-primary/30">04</span>
                  <div>
                    <div className="uppercase text-primary font-semibold tracking-widest text-xs sm:text-sm">Focus Area</div>
